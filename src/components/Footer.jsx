          ...
          <div className="container">
            <div className="content-footer-top">
              <div className="footer-logo">
                <a href="/">
                  <img src="/assets/images/logo/Easy.jpeg" alt="logo" width="166" height="48" />
                </a>
              </div>
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6">
                <div className="footer-cl-1">
                  <p className="text-variant-2">Specializes in providing high-class housing for those in need. Contact Us</p>
                  <ul className="mt-12">
                    <li className="mt-12 d-flex align-items-center gap-8">
                      <i className="icon icon-mapPinLine fs-20 text-variant-2" />
                      <p className="text-white">Rehab Community, Manitamba, Liberia</p>
                    </li>
                    <li className="mt-12 d-flex align-items-center gap-8">
                      <i className="icon icon-phone2 fs-20 text-variant-2" />
                      <a href="tel:1-333-345-6868" className="text-white caption-1">+231-888-098-674</a>
                    </li>
                    <li className="mt-12 d-flex align-items-center gap-8">
                      <i className="icon icon-mail fs-20 text-variant-2" />
                      <p className="text-white">easyrealestate@gmail.com</p>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="footer-cl-2 footer-col-block">
                  ...
                  <div className="tf-collapse-content">
                    <ul className="mt-10 navigation-menu-footer">
                      <li>
                        <a href="/pricing" className="caption-1 text-variant-2">Pricing Plans</a>
                      </li>
                      <li>
                        <a href="/our-service" className="caption-1 text-variant-2">Our Services</a>
                      </li>
                      <li>
                        <a href="/about-us" className="caption-1 text-variant-2">About Us</a>
                      </li>
                      <li>
                        <a href="/contact" className="caption-1 text-variant-2">Contact Us</a>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="col-lg-2 col-md-6">
                <div className="footer-cl-3 footer-col-block">
                  ...
                  <div className="tf-collapse-content">
                    <ul className="mt-10 navigation-menu-footer">
                      <li>
                        <a href="/topmap-list" className="caption-1 text-variant-2">Property For Sale</a>
                      </li>
                      <li>
                        <a href="/topmap-grid" className="caption-1 text-variant-2">Property For Rent</a>
                      </li>
                      <li>
                        <a href="/topmap-grid" className="caption-1 text-variant-2">Property For Buy</a>
                      </li>
                      <li>
                        <a href="/topmap-grid" className="caption-1 text-variant-2">Our Agents</a>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div className="bottom-footer">
          <div className="container">
            <div className="content-footer-bottom">
              <div className="copyright">©2025 Easy Real Estate. All Rights Reserved.</div>
              <ul className="menu-bottom">
                <li>
                  <a href="/our-service">Terms Of Services</a>
                </li>
                <li>
