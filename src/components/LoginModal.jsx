...
const LoginModal = ({ isOpen, onClose, onSwitchToRegister }) => {
  ...
  return (
    <div className="modal modal-account fade show" id="modalLogin" style={{ display: 'block' }}>
          ...
          <div className="flat-account">
            ...
            <form className="form-account" onSubmit={handleSubmit}>
              ...
              <div className="box box-btn">
                ...
                <div className="text text-center">Don't you have an account? <button type="button" onClick={onSwitchToRegister} className="text-primary">Register</button></div>
              </div>
