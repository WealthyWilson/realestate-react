...
function BuyHomeIcon() {
  return (
    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#benefit-buy-home)">
...
function RentHomeIcon() {
  return (
    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#benefit-rent-home)">
...
function SellHomeIcon() {
  return (
    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#benefit-sell-home)">
...
const imageTags = [
  {
    ...
    tags: [{ className: 'tag-item ani5', label: 'Proven Expertise' }],
  },
  {
    className: 'item-2',
    image: '/assets/images/home/office5.jpeg',
    tags: [
      { className: 'tag-item tag-item-1 ani4', label: 'Customized Solutions' },
      { className: 'tag-item tag-item-2 ani5', label: 'Transparent Partnerships' },
    ],
  },
  {
    className: 'item-3',
    image: '/assets/images/home/apartment13.jpeg',
    tags: [{ className: 'tag-item ani4', label: 'Local Area Knowledge' }],
  },
];
        ...
        <div className="flat-img-with-text-v2">
          <div className="content-left tf-image-box">
            <div className="grid-img-group">
              {imageTags.map((item) => (
                <div key={item.className} className={`tf-image-wrap ${item.className}`}>
                  <div className="img-style hover-img-wrap">
                    <img className="lazyload" data-src={item.image} src={item.image} alt="benefit" />
                  </div>
                  {item.tags.map((tag) => (
          ...
          <div className="content-right">
            <div className="box-title wow fadeInUp">
              ...
              <p className="desc text-variant-1">
                Our seasoned professionals, armed with extensive market knowledge, walk alongside you through every phase of your property endeavor.
              </p>
            </div>
            <div className="flat-service wow fadeInUp" data-wow-delay=".2s">
              {benefitCards.map((benefit) => {
                ...
                return (
                  <a key={benefit.title} href="#" className="box-benefit hover-btn-view">
