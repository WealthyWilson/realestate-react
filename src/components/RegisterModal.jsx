...
const RegisterModal = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  return (
    <div className="modal modal-account fade show" id="modalRegister" style={{ display: 'block' }}>
          ...
          <div className="flat-account">
            ...
            <form className="form-account" onSubmit={handleSubmit}>
              <div className="title-box">
                <h4>Register</h4>
                <span className="close-modal icon-close2" onClick={onClose}></span>
              </div>
              <div className="box">
              ...
              <div className="box box-btn">
                <button type="submit" className="tf-btn primary w-100">Sign Up</button>
                <div className="text text-center">Don't you have an account? <button type="button" onClick={onSwitchToLogin} className="text-primary">Sign In</button></div>
              </div>
