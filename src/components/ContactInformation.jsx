            ...
            <div className="contact-info">
              ...
              <ul>
                <li className="box">
                  ...
                  <p className="text-variant-1">Rehab Community, Manitamba<br />Liberia</p>
                </li>
                <li className="box">
                  <h6 className="title">Information:</h6>
                  <p className="text-variant-1">+231-888-098-674<br />easyrealestate@gmail.com</p>
                </li>
                <li className="box">
                  <div className="title">Opening Hours:</div>
                  <p className="text-variant-1">Monday - Friday: 08:00 - 20:00<br />Saturday - Sunday: 10:00 - 18:00</p>
                </li>
                <li className="box">
